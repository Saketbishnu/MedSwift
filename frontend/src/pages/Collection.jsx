...
const Collection = () => {
  ...
  // Apply filters to products including search
  const filteredProducts = (products || []).filter(product => {
    ...
    // Type filter (assuming product has type property)
    const typeMatch = Object.keys(typeFilters).every(key => 
      !typeFilters[key] || product.type === key
    );
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='flex-1'>
        ...
        {/* Product Grid - Updated to use ProductItem */}
